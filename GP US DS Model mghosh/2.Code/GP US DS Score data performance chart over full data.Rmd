---
title: "GP US Discount Sensitivity full score data performance Summary"
output:
...
Score_data <- merge(gp_data_all,GP_US_train_score[,c(1,22,23)],by.x = "customer_key" ,by.y = "Customer_key")
