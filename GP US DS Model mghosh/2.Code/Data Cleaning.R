...
--3859560
Onl_inact_base <- Onl_inact_base[,c('customer_key',	'offline_last_txn_date',	'offline_disc_last_txn_date',	'total_plcc_cards',	
                                    'avg_order_amt_last_6_mth',	'num_order_num_last_6_mth',	'avg_order_amt_last_12_mth',	
                                    'ratio_order_6_12_mth',	'num_order_num_last_12_mth',	'ratio_order_units_6_12_mth',	
                                    'gp_net_sales_amt_12_mth',	'gp_br_sales_ratio',	'num_disc_comm_responded',	
                                    'percent_disc_last_6_mth',	'percent_disc_last_12_mth',	'gp_go_net_sales_ratio',	'gp_bf_net_sales_ratio',	
                                    ...
                                    'num_dist_catg_purchased',	'num_units_6mth',	'num_txn_6mth',	'num_units_12mth',	'num_txn_12mth',
                                    'ratio_rev_rewd_12mth',	'ratio_rev_wo_rewd_12mth',	'num_em_campaign',	'per_elec_comm',	
                                    'on_sales_item_rev_12mth',	'on_sales_rev_ratio_12mth',	'on_sale_item_qty_12mth','Resp_Disc_Percent')]
...
Onl_inact_base <- Onl_inact_base[,!colnames(Onl_inact_base) %in% c("Resp_Disc_Percent","offline_last_txn_date","offline_disc_last_txn_date")]
...
summary(mod1_inact)
require(VIF)
keep.dat.inactive<-vif_func(in_frame=Onl_inact_base[,!colnames(Onl_inact_base) %in% c("customer_key","Response")],thresh=3,trace=F)
form.inactive2<-paste('Response ~',paste(keep.dat.inactive,collapse='+'))
mod2_inact<-lm(form.active2,data=Onl_inact_base[sample(nrow(Onl_inact_base),40000),])
summary(mod2_inact)
...
Onl_act_base <-data_full[!is.na(data_full$browse_hit_ind_tot),]
#--6507817
...
summary(mod1_act)
require(VIF)
keep.dat.active<-vif_func(in_frame=Onl_act_base[,!colnames(Onl_act_base) %in% c("customer_key","Response")],thresh=3,trace=F)
