...
```{r}
Score_Data <- read.table(file = "//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/Jun15/BR_US_DS_Score_Jun15.txt",header=TRUE, sep=",",stringsAsFactors = F)
...
auc(roc_mean_score) #0.7279149
auc(roc_median_score) #0.7277817
