---
title: "BR US Discount Sensitivity full score data performance Summary Jan15"
output:
...
```{r}
Score_Data <- read.table(file = "//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/Jan15/BR_US_DS_Score_Jan15.txt",header=TRUE, sep=",",stringsAsFactors = F)
