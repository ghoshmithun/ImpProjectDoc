...
-- Non PLCC MPC promotion Codes
 drop table if exists ${hiveconf:database}.${hiveconf:BRAND}_Monetary_disc_comm_resp_temp ;
 create table ${hiveconf:database}.${hiveconf:BRAND}_Monetary_disc_comm_resp_temp as   
...
on a.customer_key=b.customer_key
left outer join   ${hiveconf:database}.${hiveconf:BRAND}_Monetary_disc_comm_resp_temp  c 
on a.customer_key=c.customer_key
left outer join
