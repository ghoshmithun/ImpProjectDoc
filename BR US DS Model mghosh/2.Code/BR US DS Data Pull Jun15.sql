/* set database=mghosh_ds_br_jun14;
...
set BRAND = BR;
set database=mghosh_ds_${hiveconf:BRAND}_jun14;
...
SET DATE_NOW=2014-09-01;
SET DATEINDEX = 20140901;
...
customer_key,
date_time
from (select * from  ${hiveconf:database}.${hiveconf:BRAND}_browse_data_20140901
union all
select * from ${hiveconf:database}.${hiveconf:BRAND}_browse_data_20150101
union all
select * from ${hiveconf:database}.${hiveconf:BRAND}_browse_data_20150401
union all
select * from ${hiveconf:database}.${hiveconf:BRAND}_browse_data_20150701 ) a 
WHERE 
...
lines terminated by '\n' 
location '/user/mghosh/Disc_Sens_BR_jun15'
...
hadoop fs -getmerge /user/mghosh/Disc_Sens_BR_jun15/ /home/mghosh/Disc_Sens_fulldata/BR_disc_sens_Data_pull_jun15.txt
...
fields terminated by '|' 
lines terminated by '\n' 
location '/user/mghosh/Disc_Sens_BR_jun15_resp'
TBLPROPERTIES ("serialization.null.format"="");
