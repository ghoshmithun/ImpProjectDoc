...
data_full <- read.table(file="//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/BR_disc_sens_Data_pull.txt",sep="|",header=F)        
...
write.table(full_data_min_max_value,"//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/full_data_min_max_value.txt",sep="|",col.names = T,row.names = F,append=F)
...
write.table(data_full,"//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/BR_data_full.txt",sep="|",append = F,col.names = T,row.names = F)
...
write.table(important_var_full_data ,"//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/3.Documents/important_var_full_data.csv",sep=",",col.names=T,row.names = F,append = F)

require(ggplot2)
png("//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/3.Documents/important_var_full_data.png")
...
dev.off()
#data_full <- read.table("//10.8.8.51/lv0/Move to Box/Mithun/projects/7. DS_New Training/1. data/GP_data_full.txt",sep="|",header=T)
...
require(VIF)
source("C:/Users/mghosh/Box Sync/10.DS_New_Training_BR/2.Code/VIF_FUNC.R")
