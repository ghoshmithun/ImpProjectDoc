...
write.table(x = header,file="//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/Jan15/BR_US_DS_Score_Jan15.txt",sep=",",col.names=F,row.names=F,append=F)
...
require(R.utils)
total_row_scoredata <- countLines("//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/Jan15/BR_disc_sens_Data_pull_jan15.txt")
#4722436
chunk_size <- 5000000
...
BR_data <- read.table(file = "//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/Jan15/BR_disc_sens_Data_pull_jan15.txt",
...
write.table(x = score_file[,c(1,2,23,24)],file="//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/Jan15/BR_US_DS_Score_Jan15.txt",sep=",",col.names=F,row.names=F,append=T)
print("##################################################################")
...
require(ffbase)
require(ff)
#Score_Data <- read.table.ffdf(file = "//10.8.8.51/lv0/Move to Box/Mithun/projects/9.BR_US_DS_Project/1.data/Jan15/BR_US_DS_Score_Jan15.txt",header=TRUE, sep=",",VERBOSE = T,colClasses=c(rep("numeric",23)))
