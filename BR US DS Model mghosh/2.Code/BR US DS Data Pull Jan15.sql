...
SET DATE_NOW=2015-01-01;
set mapred.job.queue.name=aa;
set mapred.job.priority=VERY_HIGH;
SET hive.cli.print.header=true;
SET DATEINDEX = 20150101;
set BRAND = BR;
set database=mghosh_ds_${hiveconf:BRAND}_jan15;
...
drop table if exists ${hiveconf:database}.${hiveconf:BRAND}* ;
...
e.Num_txn_6mth, e.Num_units_12mth, e.Num_txn_12mth ,f.ratio_rev_rewd_12mth ,g.ratio_rev_wo_rewd_12mth, h.Num_EM_Campaign, 
...
SET DATE_NOW=2014-10-01;
SET DATEINDEX = 20141001;
SET DATE_NOW=2014-07-01;
SET DATEINDEX =20140701;
SET DATE_NOW=2014-04-01;
SET DATEINDEX = 20140401;
...
customer_key,
date_time
from (select * from  ${hiveconf:database}.${hiveconf:BRAND}_browse_data_20150101
union all
select * from ${hiveconf:database}.${hiveconf:BRAND}_browse_data_20141001
union all
select * from ${hiveconf:database}.${hiveconf:BRAND}_browse_data_20140701
union all
select * from ${hiveconf:database}.${hiveconf:BRAND}_browse_data_20140401 ) a 
WHERE 
...
lines terminated by '\n' 
location '/user/mghosh/Disc_Sens_BR_jan15'
...
hadoop fs -getmerge /user/mghosh/Disc_Sens_BR_jan15/ /home/mghosh/Disc_Sens_fulldata/BR_disc_sens_Data_pull_jan15.txt



--Pulling Customer Response time information
set database=mghosh_ds_br_jan15;
set mapred.job.queue.name=aa;
set mapred.job.priority=VERY_HIGH;
set BRAND = BR;
...
fields terminated by '|' 
lines terminated by '\n' 
location '/user/mghosh/Disc_Sens_BR_jan15_resp'
TBLPROPERTIES ("serialization.null.format"="");
...
hadoop fs -getmerge /user/mghosh/Disc_Sens_BR_jan15_resp/ /home/mghosh/Disc_Sens_fulldata/BR_disc_sens_Data_pull_jan15_response.txt
